              ...
              <div key={account.id} className="glass-card">
                <div className="flex items-center justify-between mb-6">
                  <div 
                    ...
                    style={{ background: 'linear-gradient(135deg, hsl(239 84% 67% / 0.2), hsl(187 94% 43% / 0.2))' }}
                  >
                ...
                {account.bank_name && (
                  <p className="text-sm text-muted-foreground mb-4">{account.bank_name}</p>
                )}
                ...
                <div className="mt-4 flex justify-between text-xs text-muted-foreground">
                  {account.account_number && (
                    <span>Acc: {account.account_number}</span>
                  )}
