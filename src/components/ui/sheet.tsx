  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 overflow-y-auto",
  {
    variants: {
      side: {
        ...
        bottom:
          "inset-x-0 bottom-0 border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom max-h-[85vh] pb-[calc(1.5rem+env(safe-area-inset-bottom))]",
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
        ...
        <SheetPrimitive.Close className={cn(
          ...
          "right-3 top-3 h-10 w-10 flex items-center justify-center bg-muted/80 backdrop-blur-sm",
          "sm:right-4 sm:top-4 sm:h-auto sm:w-auto sm:p-1 sm:bg-transparent sm:backdrop-blur-none sm:rounded-sm"
        )}>
